...
<div id="containerr">  
  ...
  ?>
    <div class="product-details">
      ...
      <div>
        <a href='update-user-self.php?id=<?php echo $row["user_id"]; ?>'><button class="btn btn-primary" style="margin-top: 10px;">Update</button></a>
      </div> 
      <?php } ?> 
    </div>
  ...
  <div class="product-image">
    ...
    <img src="upload/<?php echo $row['user_img']; ?>" alt="Profile" >
  <div class="info">
    <h2> Description</h2>
    <ul>
      ...
      <?php 
        $sqll="SELECT author FROM post WHERE author = $user_id";
        $query=mysqli_query($conn,$sqll);
        $roww=mysqli_num_rows($query);
      ?>
      <li><strong>&nbsp User have : </strong><?php echo $roww ?> <strong> Post</strong></li>
    </ul>
  </div>
</div>
<?php 
