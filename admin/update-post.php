      ...
      ?>
        ...
        <form action="save-update-post.php" method="POST" enctype="multipart/form-data" autocomplete="off">
            ...
            <div class="form-group">
                ...
                <textarea name="postdesc" class="form-control" id="your_summernote" required rows="5">
            ...
            <input type="submit" name="submit" class="btn btn-primary" value="Update" onclick='return checkDelete()' />
        </form>
        <!-- Form End -->
        <?php
          }
