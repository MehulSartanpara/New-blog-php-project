...
<div id="admin-content">
    <div class="container">
        <div class="row">
            <div class="col-md-10">
                <h1 class="admin-heading"><i class="fa fa-list-alt" aria-hidden="true"></i> All Categories</h1>
            </div>
            <div class="col-md-2">
              ...
              if (mysqli_num_rows($result) > 0) {
                  ...
                  while($row = mysqli_fetch_assoc($result)) {
                    $table .= "<tr>
                            ...
                            <td class='delete' onclick='return delcat()' ><a href='delete-category.php?id={$row['category_id']}'><i class='fa fa-trash-o'></i></a></td>
